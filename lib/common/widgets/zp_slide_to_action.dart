...
class ZPSlideAction extends StatefulWidget {
  ...
  @override
  ZPSlideActionState createState() => ZPSlideActionState();
}

/// Use a GlobalKey to access the state. This is the only way to call [SlideActionState.reset]
class ZPSlideActionState extends State<ZPSlideAction> with TickerProviderStateMixin {
  ...
  void onHorizontalDragUpdate(DragUpdateDetails details) {
    setState(() {
      _dx = (_dx + details.delta.dx).clamp(0.0, _maxDx - (widget.sliderButtonYOffset *2));
    });
  }
