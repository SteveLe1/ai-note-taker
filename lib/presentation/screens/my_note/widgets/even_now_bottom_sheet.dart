...
class EvenNowBottomSheet extends BottomSheetCommon {
  ValueChanged<int> onChanged;

  EvenNowBottomSheet({required this.onChanged});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ZPText(keyText: LocaleKeys.home_even_now, style: TextStyles.w800Size22Black3),
                  ),
                  Padding(
                    padding: EdgeInsets.only(bottom: 25.h),
                    child: ZPText(
                        keyText: LocaleKeys.home_these_are_friends_whose_contact_date, style: TextStyles.w500Size16Black5),
                  ),
                  Expanded(
